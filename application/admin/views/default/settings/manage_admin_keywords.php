...
<section class="content-header">
  <h1 class="page-title"><i class="fa fa-cog"></i> <?php echo mlx_get_lang('Manage Keywords'); ?></h1>
...
<section class="content">
	...
	echo form_open_multipart('settings/manage_admin_keywords',$attributes); 
						...
						?>
							<tr>
								...
								<td class="action_block">
									...
									<a href="<?php $segments = array('settings','delete_keyword','admin',$myHelpers->EncryptClientId($row->lang_id)); 
									 echo site_url($segments);?>" 
									onClick="return confirm('Do you really want to delete this keyword?');"
									title="<?php echo mlx_get_lang('Delete'); ?>" data-toggle="tooltip" class="btn btn-danger btn-xs delete-property"><i class="fa fa-trash"></i></a>
