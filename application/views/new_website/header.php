...
?>
	...
	<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=<?php echo $custom_fonts;?>">
...
<body class="<?php echo $style_theme; ?>" <?php if(isset($cur_page) && $cur_page == 'home') { ?>id="home" <?php } ?>>
	...
	<?php $this->load->view("$theme/top-header"); ?>
	<?php $this->load->view($content); ?>
	<?php $this->load->view("$theme/bottom-footer"); ?>
