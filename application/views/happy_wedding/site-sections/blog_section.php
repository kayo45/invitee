...
<section class="blog-section section-padding" id="blogs">
	<div class="container">
		...
		<?php if(isset($settings['show_view_more_btn']) && $settings['show_view_more_btn'] == 'yes'){ ?>
		<div class="row">
			<div class="col-md-12 text-center">
				<a href="<?php echo base_url(); ?>blogs" class="theme-btn"><?php echo $settings['blog_load_more_btn_text'];  ?></a>
			</div>
		</div>
		<?php } ?>
	</div>
